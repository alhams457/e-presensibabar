<div class="page-content">
    <div class="container-fluid"> 
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body p-4 bg-soft-blue text-center rounded-top">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body p-4 bg-soft-pink text-center rounded-top">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body p-4 bg-soft-success text-center rounded-top">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body p-4 bg-soft-warning text-center rounded-top">
